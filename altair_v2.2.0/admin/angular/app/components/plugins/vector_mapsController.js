angular
    ...
    .controller('vector_mapsCtrl', [
        ...
        function ($rootScope,utils) {
            ...
            var marker_url = utils.isHighDensity() ? 'assets/img/md-images/ic_place_black_48dp.png' : 'assets/img/md-images/ic_place_black_24dp.png',
                marker_url_beenhere = utils.isHighDensity() ? 'assets/img/md-images/ic_beenhere_black_48dp.png' : 'assets/img/md-images/ic_beenhere_black_24dp.png';
                ...
                legend: {
                    plot: {
                        ...
                        slices: [{
                            ...
                            type: "image",
                            url: marker_url,
                            width: utils.isHighDensity() ? 48 : 24,
                            height: utils.isHighDensity() ? 48 : 24,
                            attrsHover: {
                                transform: "s1.4"
                            }
                        }, {
